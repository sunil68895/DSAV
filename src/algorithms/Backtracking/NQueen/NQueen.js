...
class NQueen extends Component {
  ...
  render() {
    ...
    return (
      <div className='jumbotron jumbotron-fluid' style={{backgroundColor:"#4fc3f7"}}>
        <div className='container' >
          <div className='row'>
            <div className='col-sm-8' style={{backgroundColor:"#659D"}}>
              <div className='row'>
                <div className='col-sm-12'></div>
              </div>
              <div className='Qbox Qboard mb-2' style={{backgroundColor:"#e3f2fd"}}id='NQueensBoard'></div>
              <div className='row'>
                <div className='input-group mt-2 container col-sm-6' style={{padding:"15px"}}>
                  <div className='input-group-prepend' style={{height:"30px"}}>
                    <span className='input-group-text' style={{height:"30px",marginRight:"5px"}}>Board Size</span>
                  </div>
                  <div className='ui labeled input'>
                    <input
                      style={{zIndex:"0", height:"5px"}}
                      type='number'
                      id='boardInput'
                      className='mr-3'
                  ...
                  <div className='input-group-append'>
                    ...
                    <button
                    style={{zIndex:"1" ,margin:"15px 1px", color:'black'}}
