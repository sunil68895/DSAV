...
export default class Sudoku extends Component {
  ...
  render() {
    return (
      <div className='jumbotron-fluid bg'>
        <br />
        <br />
        <center>
          <div id='messages'></div>
        ...
        <div className='col-sm-7' >
          ...
          <div className='col-sm-5 mt-2'>
            ...
            <button
             style={{borderRadius:'10px', height:'40px'}}
              className='mt-2 mr-5 ui purple button solveButton'
            ...
            className='mt-2 mr-5 ui green button generateButton'
          ...
          >
            ...
            <button
            style={{borderRadius:'10px' , height:'40px'}}
              className='mt-2 mr-5 ui pink button solveNow'
