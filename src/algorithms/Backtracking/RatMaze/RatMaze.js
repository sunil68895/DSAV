      ...
      <div className='container-fluid'>
        <div className='row'>
          <div className='col-sm-7'>
            <div className='Rbox Rboard mt-2' style={{backgroundColor:"rgb(105,105,105)"}} id='ratMazeBoard'></div>
          </div>
          <div className='col-sm-5 mt-2'>
            ...
            <br />
            <div>
              <b style={{color:"purple"}}>Rat only moves in two directions - Forward and Down</b>
            </div>
          </div>
        </div>
      </div>
